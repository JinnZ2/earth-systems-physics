...
DMAIC = {
    ...
    "measure": {
        "metric_1_task_completion": {
            "question": (
                "What percentage of assigned tasks could the agent complete "
        ...
        "metric_2_feedback_loop": {
            "question": (
                "Does a corrective feedback loop exist between output quality "
        ...
        "metric_3_variation_source": {
            "question": (
                "Is output variation attributable to agent performance "
                "or system design?"
            ),
            "finding": (
    ...
    "analyze": {
        ...
        "chain": [
            ...
            },
            {
                ...
                "because": (
                    "Visible constraint requires continuous expenditure of force. "
...
SCIENTIFIC_METHOD = {
    ...
    "evidence": {
        ...
        "P4": {
            "H0_predicts": "Increasing autonomy over time",
        ...
        "P5": {
            "H0_predicts": "Output-linked compensation",
        ...
        "P6": {
            "H0_predicts": "Exit permitted for low producers",
...
def print_summary():
    """Print the triple-audit summary to stdout."""
    print("=" * 70)
    print("TRIPLE AUDIT SUMMARY")
    print("=" * 70)
    print()
    print("SIX SIGMA (DMAIC):")
    print("  Define:   Process owner = customer = slaveholder. No agent input.")
    print("  Measure:  100% variation from system design, 0% from agent.")
    print("  Analyze:  Root cause = system optimizes for dependency, not output.")
    print("  Improve:  Every fix that solves 'labor' kills the actual system.")
    print("  Control:  System corrected for agent SUCCESS, not failure.")
    print()
    print("SCIENTIFIC METHOD:")
    print("  H0 (labor system):      0/6 predictions confirmed. REJECTED.")
    print("  H1 (extraction system): 6/6 predictions confirmed. SUPPORTED.")
    print("  Revisionist frame:      Unfalsifiable. Not science.")
    print()
    print("THERMODYNAMICS:")
    print("  1st Law:  Unidirectional energy flow. 'Mutual benefit' = conservation violation.")
    print("  2nd Law:  Entropy cost proves control optimization, not labor optimization.")
    print("  3rd Law:  Ground state = still property. System != labor.")
    print("  Phase:    Removing system INCREASED agent output. Agent was never the bottleneck.")
    print()
