...
CASCADE_MAP = {
    ...
    (4, "total_bottom_water_Sv"):  [(3, "deep ventilation rate -> atmospheric CO2 uptake", False),
                                    (6, "nutrient upwelling from deep water renewal", True)],
    (4, "deep_convection_active"): [(3, "deep convective heat release to atmosphere", True),
                                    (5, "bottom water density -> seafloor pressure loading", False)],
