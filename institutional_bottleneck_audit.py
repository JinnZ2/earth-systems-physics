...
class RegulatoryNode:
    ...
    def accountability_statement(self) -> str:
        ...
        return (
            ...
            f"justified. Each month of inaction = "
            f"~{self.lives_per_month_delay/1e3:.0f}k "
...
DEFENSES_THAT_FAIL = [
    ...
    },
    {
        ...
        "rebuttal": "Thermophilic composting at 55 C for 3 days achieves "
    ...
    },
    {
        ...
        "rebuttal": "Markets are the AMPLIFIER (price-based exclusion) "
                    "documented in leverage_analysis.py - they concentrate "
...
def aggregate_lives_per_month():
    """Sum lives_per_month_delay across all regulatory choke points."""
    return sum(n.lives_per_month_delay for n in REGULATORY_BOTTLENECKS)
