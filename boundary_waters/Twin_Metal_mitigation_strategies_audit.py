...
“required timescale. Any positive annual energy flux × infinite “
...
│ (accelerated 10²- │    lakes, vegetation
│  10⁶× by microbes)│
└───────────────────┘
│
▼
...
“section_A_mitigation_dependencies”: [m.**dict** for m in MITIGATIONS],
“section_B_externality_ledger”:       [e.**dict** for e in EXTERNALITIES],
“section_C_eroi_stack”:               [c.**dict** for c in EROI_STACK],
“section_C_headline”:                  EROI_HEADLINE,
“section_D_flow_diagram”:              FLOW_DIAGRAM,
“section_E_failure_thermodynamics”:    FAILURE_THERMO,
“section_F_falsifiable_thermo_claims”:[t.**dict** for t in THERMO_CLAIMS],
