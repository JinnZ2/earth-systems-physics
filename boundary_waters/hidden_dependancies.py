...
def emit_hidden_dep_audit():
    return {
        ...
        "section_G_scarce_resources":        [s.__dict__ for s in SCARCE],
        "section_H_manufacturing_chains":    [m.__dict__ for m in MFG_CHAINS],
        ...
        "section_L_falsifiable_claims":      [c.__dict__ for c in HIDDEN_CLAIMS],
