...
pytest -v                             # Run test suite (225 tests)
```
...
├── test_smoke.py                      # 225 tests — all layers, scenarios, validators, audits
│
...
Framework: **pytest** — 225 tests covering all layers, scenarios, validators, magnomechanical integration, climate-scheme audits, systems audits, epistemology models, sensor-corruption models, and consequence dynamics.
