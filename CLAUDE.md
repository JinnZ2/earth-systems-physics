...
pytest -v                             # Run test suite (1265 tests)
```
...
│   └── catalogs/                      # 39 .jsonl catalogs auto-exported from sources
│
├── experiments/
...
Framework: **pytest** — 1265 tests covering all layers, scenarios, validators, magnomechanical integration, climate-scheme audits, systems audits, epistemology models, sensor-corruption models, and consequence dynamics.
...
├── composition_recipes.md  Cross-module analysis patterns
├── index.json              Provenance + schema for every catalog
└── catalogs/               39 .jsonl catalogs (302 records total)
