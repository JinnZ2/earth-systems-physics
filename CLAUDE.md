...
pytest -v                             # Run test suite (1290 tests)
```
...
│   └── catalogs/                      # 40 .jsonl catalogs auto-exported from sources
│
├── experiments/
...
Framework: **pytest** — 1290 tests covering all layers, scenarios, validators, magnomechanical integration, climate-scheme audits, systems audits, epistemology models, sensor-corruption models, and consequence dynamics.
...
├── composition_recipes.md  Cross-module analysis patterns
├── index.json              Provenance + schema for every catalog
└── catalogs/               40 .jsonl catalogs (314 records total)
